...
(function () {
    'use strict';
    angular.module('app.filetobeupload', []);
})();
(function () {
    'use strict';
...
(function () {
    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper) {
        ...
        $stateProvider.state('app', {
            ...
            .state('page', {
            ...
            }).state('app.attributebulkinsert', {
                url: '/attributebulkinsert'
                ...
                , templateUrl: helper.basepath('mainpages/bulkform.html')
                , controller: 'materialbulkinsertcontroller'
                , controllerAs: 'bulk'
            }).state('app.materialbulkupdate', {
                url: '/materialbulkupdate'
                , title: 'materialbulkupdate '
                , templateUrl: helper.basepath('mainpages/bulkform.html')
                ...
                url: '/addmaterial'
                , title: 'addmaterial'
                , templateUrl: helper.basepath('mainpages/materialform.html')
            }).state('app.editmaterial', {
                url: '/editmaterial/:updateid'
                , title: 'editmaterial'
                , templateUrl: helper.basepath('mainpages/materialform.html')
            }).state('app.metrics', {
                url: '/metrics'
                ...
                url: '/addmetrics'
                , title: 'addmetrics'
                , templateUrl: helper.basepath('mainpages/metricsform.html')
            }).state('app.editmetrics', {
                url: '/editmetrics/:updateid'
                , title: 'editmetrics'
                , templateUrl: helper.basepath('mainpages/metricsform.html')
            }).state('app.attribute', {
                url: '/attribute'
                ...
                url: '/addcategories'
                , title: 'addcategories'
                , templateUrl: helper.basepath('mainpages/addcategories.html')
            }).state('page.lock', {
                url: '/lock'
                , title: 'Lock'
...
(function () {
    ...
    function attributeController($scope, $http, $state, $location, SweetAlert) {
        ...
        function activateview() {
            $http.get("http://localhost:3000/api/attributes/listattribute?attributegrandparent=" + vm.attributegrandparent + "&status=1&access_token=metricmangement").then(function (response) {
                console.log(response.data);
...
// validation for materialController.........
(function () {
    'use strict';
...
// validation for metricsController.........
(function () {
    'use strict';
    ...
    function metricsController($scope, $http, $state, $location, SweetAlert) {
        ...
        vm.addmetrics = function () {
            $state.go("app.addmetrics");
        };
        vm.editmetrics = function (id) {
            $state.go("app.editmetrics", {
                'updateid': id
            });
        };
        vm.deleterow = function (id) {
...
// addmaterialController validations....
(function () {
    'use strict';
    angular.module('app.forms').controller('addmaterialController', addmaterialController);

    function addmaterialController($scope, $http, $state, $location) {
        var vm = this;
        vm.submitted = false;
        vm.validateInput = function (name, type) {
            var input = vm.formValidate[name];
        ...
        vm.producttitle = "Material Management";
        vm.modifyby = "admin";
        ...
        if (vm.updateid != undefined) {
            ...
            vm.producttitle = "Update Material Management";
            $http.get("http://localhost:3000/api/materials/listmaterialone?id=" + vm.updateid + "&access_token=metricmangement").then(function (response) {
                vm.setdata = response.data[0];
                console.log(vm.setdata);
                vm.name = vm.setdata[0].name;
                vm.category = vm.setdata[0].category;
                vm.defaultmetrics = vm.setdata[0].defaultmetrics;
...
(function () {
    'use strict';
    angular.module('app.forms').controller('addmetricsController', addmetricsController);

    function addmetricsController($scope, $http, $state, $location) {
        var vm = this;
        vm.submitted = false;
        vm.validateInput = function (name, type) {
            var input = vm.formValidate[name];
        ...
        vm.producttitle = "Metric Management";
        vm.modifyby = "admin";
        vm.modifyon = "current date";
        vm.disabled = '';
        vm.updateid = $state.params.updateid;
        if (vm.updateid != undefined) {
            vm.disabled = 'disabled="disabled"';
            vm.producttitle = "Update Metric Management";
            $http.get("http://localhost:3000/api/metrics/listmetricone?id=" + vm.updateid + "&access_token=metricmangement").then(function (response) {
                ...
                console.log(vm.setdata);
                vm.name = vm.setdata[0].name;
                vm.symbol = vm.setdata[0].symbol;
                vm.baseunit = vm.setdata[0].baseunit;
                vm.multiple = vm.setdata[0].multiple;
                vm.activestatus = vm.setdata[0].activestatus;
            });
        }
        console.log(vm.updateid);
...
(function () {
    'use strict';
    angular.module('app.forms').controller('addattributeController', addattributeController);

    function addattributeController($scope, $http, $state, $location) {
        var vm = this;
        vm.submitted = false;
        vm.validateInput = function (name, type) {
            var input = vm.formValidate[name];
        ...
        if (vm.updateid != undefined) {
            ...
            $http.get("http://localhost:3000/api/attributes/listattributeone?id=" + vm.updateid + "&access_token=metricmangement").then(function (response) {
                ...
                vm.attributerole = vm.setdata[0].attributerole;
                vm.activestatus = vm.setdata[0].activestatus;
            });
        }
        console.log(vm.updateid);
